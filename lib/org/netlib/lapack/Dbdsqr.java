...
label1:
            {
                ...
                if(Lsame.lsame(s, "U") ^ true && flag ^ true)
                    intw.val = -1;
                else
                if(i < 0)
                    intw.val = -2;
                ...
                if(i != 1)
                {
                    ...
                    if(flag)
                    {
                        ...
                        if(k > 0)
                            Dlasr.dlasr("R", "V", "F", k, i, ad5, (1 - 1) + i3, ad5, (i - 1) + i3, ad3, i2, j2);
                        if(l > 0)
                            Dlasr.dlasr("L", "V", "F", i, l, ad5, (1 - 1) + i3, ad5, (i - 1) + i3, ad4, k2, l2);
                    }
                    double d36 = Math.max(10D, Math.min(100D, Math.pow(d5, -0.125D)));
                    double d34 = d36 * d5;
                    double d22 = 0.0D;
                    j3 = 1;
                    ...
                    if(d34 >= 0.0D)
                    {
                        ...
                        if(d30 != 0.0D)
                        {
                            ...
                            {
                                d16 = Math.abs(ad[(j3 - 1) + i1]) * (d16 / (d16 + Math.abs(ad1[(j3 - 1 - 1) + j1])));
...
label4:
                            {
                                ...
                                if(i4 > l5)
                                    break label1;
                                if((d34 < 0.0D) && (Math.abs(ad[(k5 - 1) + i1]) <= d32))
                                    ad[(k5 - 1) + i1] = 0.0D;
                                d23 = Math.abs(ad[(k5 - 1) + i1]);
                                double d25 = d23;
                                int l4 = 1;
                                for(int j8 = (k5 - 1 - 1) + 1; j8 > 0; j8--)
                                {
                                    k4 = k5 - l4;
                        ...
                        if(k4 == k5 - 1)
                        {
                            Dlasv2.dlasv2(ad[(k5 - 1 - 1) + i1], ad1[(k5 - 1 - 1) + j1], ad[(k5 - 1) + i1], doublew7, doublew8, doublew10, doublew1, doublew9, doublew);
                            ad[(k5 - 1 - 1) + i1] = doublew8.val;
                            ad1[(k5 - 1 - 1) + j1] = 0.0D;
                            ad[(k5 - 1) + i1] = doublew7.val;
                            if(j > 0)
                                Drot.drot(j, ad2, (k5 - 1 - 1) + (1 - 1) * l1 + k1, l1, ad2, (k5 - 1) + (1 - 1) * l1 + k1, l1, doublew1.val, doublew10.val);
                            if(k > 0)
                                Drot.drot(k, ad3, (1 - 1) + (k5 - 1 - 1) * j2 + i2, 1, ad3, (1 - 1) + (k5 - 1) * j2 + i2, 1, doublew.val, doublew9.val);
                            if(l > 0)
                                Drot.drot(l, ad4, (k5 - 1 - 1) + (1 - 1) * l2 + k2, l2, ad4, (k5 - 1) + (1 - 1) * l2 + k2, l2, doublew.val, doublew9.val);
                            k5 -= 2;
                            continue;
                        }
                        if((k4 > i7) || (k5 < l6))
                        ...
                        if(byte0 == 1)
                        {
                            if((Math.abs(ad1[(k5 - 1 - 1) + j1]) <= Math.abs(d34) * Math.abs(ad[(k5 - 1) + i1])) || ((d34 < 0.0D) && (Math.abs(ad1[(k5 - 1 - 1) + j1]) <= d32)))
                            {
                                ad1[(k5 - 1 - 1) + j1] = 0.0D;
                                continue;
                            }
                            if(d34 >= 0.0D)
                            {
                                ...
                                for(int k8 = (k5 - 1 - k4) + 1; k8 > 0; k8--)
                                {
                                    ...
                                    d17 = Math.abs(ad[((i5 + 1) - 1) + i1]) * (d17 / (d17 + Math.abs(ad1[(i5 - 1) + j1])));
                        ...
                        {
                            if((Math.abs(ad1[(k4 - 1) + j1]) <= Math.abs(d34) * Math.abs(ad[(k4 - 1) + i1])) || ((d34 < 0.0D) && (Math.abs(ad1[(k4 - 1) + j1]) <= d32)))
                            {
                                ad1[(k4 - 1) + j1] = 0.0D;
                                continue;
                            }
                        ...
                        l6 = k4;
                        i7 = k5;
                        if((d34 >= 0.0D) && ((double)i * d34 * (d28 / d23) <= Math.max(d5, 0.01D * d34)))
                        {
                            doublew6.val = 0.0D;
                        } else
                        {
                            ...
                            if(byte0 == 1)
                            {
                                ...
                                Dlas2.dlas2(ad[(k5 - 1 - 1) + i1], ad1[(k5 - 1 - 1) + j1], ad[(k5 - 1) + i1], doublew6, doublew5);
                            } else
                            {
                                d20 = Math.abs(ad[(k5 - 1) + i1]);
                                Dlas2.dlas2(ad[(k4 - 1) + i1], ad1[(k4 - 1) + j1], ad[((k4 + 1) - 1) + i1], doublew6, doublew5);
                            }
                            if((d20 > 0.0D) && (Math.pow(doublew6.val / d20, 2) < d5))
                                doublew6.val = 0.0D;
                        }
                        i4 = (i4 + k5) - k4;
                        if(doublew6.val == 0.0D)
                        {
                            if(byte0 == 1)
                            {
                                ...
                                for(int i9 = (k5 - 1 - k4) + 1; i9 > 0; i9--)
                                {
                                    ...
                                    if(j3 > k4)
                                        ad1[(j3 - 1 - 1) + j1] = doublew4.val * doublew5.val;
                                ...
                                ad1[(k5 - 1 - 1) + j1] = d13 * doublew4.val;
                                if(j > 0)
                                    Dlasr.dlasr("L", "V", "F", (k5 - k4) + 1, j, ad5, (1 - 1) + i3, ad5, (i - 1) + i3, ad2, (k4 - 1) + (1 - 1) * l1 + k1, l1);
                                if(k > 0)
                                    Dlasr.dlasr("R", "V", "F", k, (k5 - k4) + 1, ad5, ((j6 + 1) - 1) + i3, ad5, ((k6 + 1) - 1) + i3, ad3, (1 - 1) + (k4 - 1) * j2 + i2, j2);
                                if(l > 0)
                                    Dlasr.dlasr("L", "V", "F", (k5 - k4) + 1, l, ad5, ((j6 + 1) - 1) + i3, ad5, ((k6 + 1) - 1) + i3, ad4, (k4 - 1) + (1 - 1) * l2 + k2, l2);
                            ...
                            } else
                            {
                                ...
                                {
                                    Dlartg.dlartg(ad[(j3 - 1) + i1] * doublew2.val, ad1[(j3 - 1 - 1) + j1], doublew2, doublew11, doublew5);
                                    if(j3 < k5)
                                ...
                                if(j > 0)
                                    Dlasr.dlasr("L", "V", "B", (k5 - k4) + 1, j, ad5, ((j6 + 1) - 1) + i3, ad5, ((k6 + 1) - 1) + i3, ad2, (k4 - 1) + (1 - 1) * l1 + k1, l1);
                                if(k > 0)
                                    Dlasr.dlasr("R", "V", "B", k, (k5 - k4) + 1, ad5, (1 - 1) + i3, ad5, (i - 1) + i3, ad3, (1 - 1) + (k4 - 1) * j2 + i2, j2);
                                if(l > 0)
                                    Dlasr.dlasr("L", "V", "B", (k5 - k4) + 1, l, ad5, (1 - 1) + i3, ad5, (i - 1) + i3, ad4, (k4 - 1) + (1 - 1) * l2 + k2, l2);
                        ...
                        if(byte0 == 1)
                        {
                            double d7 = (Math.abs(ad[(k4 - 1) + i1]) - doublew6.val) * (Util.dsign(1.0D, ad[(k4 - 1) + i1]) + doublew6.val / ad[(k4 - 1) + i1]);
                        ...
                        {
                            double d8 = (Math.abs(ad[(k5 - 1) + i1]) - doublew6.val) * (Util.dsign(1.0D, ad[(k5 - 1) + i1]) + doublew6.val / ad[(k5 - 1) + i1]);
                            double d11 = ad1[(k5 - 1 - 1) + j1];
                            j3 = k5;
                            for(int l9 = (((k4 + 1) - k5) + -1) / -1; l9 > 0; l9--)
                            {
                                ...
                                d8 = doublew1.val * ad[(j3 - 1) + i1] + doublew10.val * ad1[(j3 - 1 - 1) + j1];
                                ad1[(j3 - 1 - 1) + j1] = doublew1.val * ad1[(j3 - 1 - 1) + j1] - doublew10.val * ad[(j3 - 1) + i1];
                                d11 = doublew10.val * ad[(j3 - 1 - 1) + i1];
                                ad[(j3 - 1 - 1) + i1] = doublew1.val * ad[(j3 - 1 - 1) + i1];
                                Dlartg.dlartg(d8, d11, doublew, doublew9, doublew5);
                                ad[(j3 - 1) + i1] = doublew5.val;
                                d8 = doublew.val * ad1[(j3 - 1 - 1) + j1] + doublew9.val * ad[(j3 - 1 - 1) + i1];
                                ad[(j3 - 1 - 1) + i1] = doublew.val * ad[(j3 - 1 - 1) + i1] - doublew9.val * ad1[(j3 - 1 - 1) + j1];
                                if(j3 > k4 + 1)
                                {
                                    d11 = doublew9.val * ad1[(j3 - 2 - 1) + j1];
                                    ad1[(j3 - 2 - 1) + j1] = doublew.val * ad1[(j3 - 2 - 1) + j1];
                                }
                ...
                for(int i10 = (i - 1) + 1; i10 > 0; i10--)
                {
                    if(ad[(j3 - 1) + i1] < 0.0D)
                    {
                        ...
                        if(j > 0)
                            Dscal.dscal(j, -1D, ad2, (j3 - 1) + (1 - 1) * l1 + k1, l1);
                    }
                    j3++;
                }

                j3 = 1;
                for(int j10 = (i - 1 - 1) + 1; j10 > 0; j10--)
                {
                    int l3 = 1;
                    double d26 = ad[(1 - 1) + i1];
                    int j4 = 2;
                    ...
                    if(l3 != (i + 1) - j3)
                    {
                        ...
                        ad[((i + 1) - j3 - 1) + i1] = d26;
                        if(j > 0)
                            Dswap.dswap(j, ad2, (l3 - 1) + (1 - 1) * l1 + k1, l1, ad2, ((i + 1) - j3 - 1) + (1 - 1) * l1 + k1, l1);
                        if(k > 0)
                            Dswap.dswap(k, ad3, (1 - 1) + (l3 - 1) * j2 + i2, 1, ad3, (1 - 1) + ((i + 1) - j3 - 1) * j2 + i2, 1);
                        if(l > 0)
                            Dswap.dswap(l, ad4, (l3 - 1) + (1 - 1) * l2 + k2, l2, ad4, ((i + 1) - j3 - 1) + (1 - 1) * l2 + k2, l2);
                    }
                    j3++;
                }
