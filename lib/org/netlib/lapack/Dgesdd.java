...
public final class Dgesdd
{
            ...
            int j2, int k2, int ai[], int l2, intW intw)
    {
        ...
        flag = k2 == -1;
        if((((flag1 || flag5) || flag4) || flag3) ^ true)
            intw.val = -1;
        else
        if(i < 0)
            intw.val = -2;
        ...
        if(i >= j)
        {
            if(i >= i19)
            {
                if(flag3)
                {
                    ...
                    Dlaset.dlaset("L", j - 1, j - 1, 0.0D, 0.0D, ad, (2 - 1) + (1 - 1) * l + k, l);
                    int i5 = 1;
                    int k12 = i5 + j;
                    int i10 = k12 + j;
                    j19 = i10 + j;
                ...
                if(flag4)
                {
                    ...
                    Dlaset.dlaset("L", j - 1, j - 1, 0.0D, 0.0D, ad4, ((l7 + 1) - 1) + j2, k17);
                    ...
                    for(int j24 = ((i - 1) + k17) / k17; j24 > 0; j24--)
                    {
                        ...
                        Dgemm.dgemm("N", "N", l3, j, j, 1.0D, ad, (i4 - 1) + (1 - 1) * l + k, l, ad4, (i15 - 1) + j2, j, 0.0D, ad4, (l7 - 1) + j2, k17);
                        Dlacpy.dlacpy("F", l3, j, ad4, (l7 - 1) + j2, k17, ad, (i4 - 1) + (1 - 1) * l + k, l);
                        i4 += k17;
                    }
                ...
                if(flag5)
                {
                    ...
                    Dgemm.dgemm("N", "N", i, j, j, 1.0D, ad, k, l, ad4, (l7 - 1) + j2, k17, 0.0D, ad2, j1, k1);
                } else
                if(flag1)
                {
                    int j15 = 1;
                    ...
                    Dgemm.dgemm("N", "N", i, j, j, 1.0D, ad2, j1, k1, ad4, (j15 - 1) + j2, l17, 0.0D, ad, k, l);
            ...
            } else
            {
                ...
                if(flag4)
                {
                    ...
                    if(k2 >= i * j + 3 * j + i3)
                    {
                        i18 = i;
                        j20 = k15 + i18 * j;
                        Dlaset.dlaset("F", i, j, 0.0D, 0.0D, ad4, (k15 - 1) + j2, i18);
                    } else
                    {
                        i18 = j;
                        j20 = k15 + i18 * j;
                    ...
                    } else
                    {
                        ...
                        for(int k24 = ((i - 1) + k17) / k17; k24 > 0; k24--)
                        {
                            ...
                            Dgemm.dgemm("N", "N", l3, j, j, 1.0D, ad, (j4 - 1) + (1 - 1) * l + k, l, ad4, (k15 - 1) + j2, i18, 0.0D, ad4, (l7 - 1) + j2, k17);
                            Dlacpy.dlacpy("F", l3, j, ad4, (l7 - 1) + j2, k17, ad, (j4 - 1) + (1 - 1) * l + k, l);
                            j4 += k17;
                        }
                ...
                if(flag5)
                {
                    Dlaset.dlaset("F", i, j, 0.0D, 0.0D, ad2, j1, k1);
                ...
                if(flag1)
                {
                    Dlaset.dlaset("F", i, i, 0.0D, 0.0D, ad2, j1, k1);
                    Dbdsdc.dbdsdc("U", "I", j, ad1, i1, ad4, (i6 - 1) + j2, ad2, j1, k1, ad3, l1, i2, ad5, 0, ai1, 0, ad4, (j20 - 1) + j2, ai, l2, intw);
                    if(i > j)
                        Dlaset.dlaset("F", i - j, i - j, 0.0D, 1.0D, ad2, ((j + 1) - 1) + ((j + 1) - 1) * k1 + j1, k1);
        ...
        if(j >= i19)
        {
            if(flag3)
            {
                ...
                Dlaset.dlaset("U", i - 1, i - 1, 0.0D, 0.0D, ad, (1 - 1) + (2 - 1) * l + k, l);
                int j6 = 1;
                int l13 = j6 + i;
                int j11 = l13 + i;
                k20 = j11 + i;
            ...
            if(flag4)
            {
                ...
                Dlaset.dlaset("U", i - 1, i - 1, 0.0D, 0.0D, ad4, ((k7 + i17) - 1) + j2, i17);
                ...
                for(int l24 = ((j - 1) + l3) / l3; l24 > 0; l24--)
                {
                    ...
                    Dgemm.dgemm("N", "N", i, j3, i, 1.0D, ad4, (l15 - 1) + j2, i, ad, (1 - 1) + (k4 - 1) * l + k, l, 0.0D, ad4, (k7 - 1) + j2, i17);
                    Dlacpy.dlacpy("F", i, j3, ad4, (k7 - 1) + j2, i17, ad, (1 - 1) + (k4 - 1) * l + k, l);
                    k4 += l3;
                }
            ...
            if(flag5)
            {
                ...
                Dlaset.dlaset("U", i - 1, i - 1, 0.0D, 0.0D, ad4, ((k7 + j17) - 1) + j2, j17);
                ...
                Dgemm.dgemm("N", "N", i, j, i, 1.0D, ad4, (k7 - 1) + j2, j17, ad, k, l, 0.0D, ad3, l1, i2);
            } else
            if(flag1)
            {
                int i16 = 1;
                ...
                Dgemm.dgemm("N", "N", i, j, i, 1.0D, ad4, (i16 - 1) + j2, k16, ad3, l1, i2, 0.0D, ad, k, l);
        ...
        } else
        {
            ...
            if(flag4)
            {
                ...
                if(k2 >= i * j + 3 * i + i3)
                {
                    Dlaset.dlaset("F", i, j, 0.0D, 0.0D, ad4, (j16 - 1) + j2, l16);
                    k21 = j16 + l16 * j;
                } else
                {
                    k21 = j16 + l16 * i;
                ...
                } else
                {
                    ...
                    for(int i25 = ((j - 1) + l3) / l3; i25 > 0; i25--)
                    {
                        ...
                        Dgemm.dgemm("N", "N", i, k3, i, 1.0D, ad4, (j16 - 1) + j2, l16, ad, (1 - 1) + (l4 - 1) * l + k, l, 0.0D, ad4, (k7 - 1) + j2, i);
                        Dlacpy.dlacpy("F", i, k3, ad4, (k7 - 1) + j2, i, ad, (1 - 1) + (l4 - 1) * l + k, l);
                        l4 += l3;
                    }
            ...
            if(flag5)
            {
                Dlaset.dlaset("F", i, j, 0.0D, 0.0D, ad3, l1, i2);
            ...
            if(flag1)
            {
                Dlaset.dlaset("F", j, j, 0.0D, 0.0D, ad3, l1, i2);
                Dbdsdc.dbdsdc("L", "I", i, ad1, i1, ad4, (j7 - 1) + j2, ad2, j1, k1, ad3, l1, i2, ad5, 0, ai1, 0, ad4, (k21 - 1) + j2, ai, l2, intw);
                if(j > i)
                    Dlaset.dlaset("F", j - i, j - i, 0.0D, 1.0D, ad3, ((i + 1) - 1) + ((i + 1) - 1) * i2 + l1, i2);
                Dormbr.dormbr("Q", "L", "N", i, i, j, ad, k, l, ad4, (l14 - 1) + j2, ad2, j1, k1, ad4, (k21 - 1) + j2, (k2 - k21) + 1, intw1);
