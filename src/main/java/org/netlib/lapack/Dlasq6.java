            ...
            doubleW doublew3, doubleW doublew4, doubleW doublew5)
    {
        ...
        if(l == 0)
        {
            ...
            for(int k1 = ((4 * (j - 3) - 4 * i) + 4) / 4; k1 > 0; k1--)
            {
                ...
                {
                    ad[(i1 - 1) + k] = ad[((i1 + 1) - 1) + k] * (ad[(i1 - 1 - 1) + k] / ad[(i1 - 2 - 1) + k]);
                    d = ad[((i1 + 1) - 1) + k] * (d / ad[(i1 - 2 - 1) + k]);
                }
        ...
        } else
        {
            ...
            for(int l1 = ((4 * (j - 3) - 4 * i) + 4) / 4; l1 > 0; l1--)
            {
                ...
                if((d2 * ad[((i1 + 2) - 1) + k] < ad[(i1 - 3 - 1) + k]) && (d2 * ad[(i1 - 3 - 1) + k] < ad[((i1 + 2) - 1) + k]))
                {
                    double d5 = ad[((i1 + 2) - 1) + k] / ad[(i1 - 3 - 1) + k];
                    ad[(i1 - 1 - 1) + k] = ad[(i1 - 1) + k] * d5;
                    d *= d5;
                } else
                {
                    ad[(i1 - 1 - 1) + k] = ad[((i1 + 2) - 1) + k] * (ad[(i1 - 1) + k] / ad[(i1 - 3 - 1) + k]);
        ...
        i1 = 4 * (j - 2) - l;
        j1 = (i1 + 2 * l) - 1;
        ad[(i1 - 2 - 1) + k] = doublew5.val + ad[(j1 - 1) + k];
        if(ad[(i1 - 2 - 1) + k] == 0.0D)
        {
            ad[(i1 - 1) + k] = 0.0D;
        ...
        if((d2 * ad[((j1 + 2) - 1) + k] < ad[(i1 - 2 - 1) + k]) && (d2 * ad[(i1 - 2 - 1) + k] < ad[((j1 + 2) - 1) + k]))
        {
            double d6 = ad[((j1 + 2) - 1) + k] / ad[(i1 - 2 - 1) + k];
            ad[(i1 - 1) + k] = ad[(j1 - 1) + k] * d6;
            doublew4.val = doublew5.val * d6;
        } else
        {
            ad[(i1 - 1) + k] = ad[((j1 + 2) - 1) + k] * (ad[(j1 - 1) + k] / ad[(i1 - 2 - 1) + k]);
            doublew4.val = ad[((j1 + 2) - 1) + k] * (doublew5.val / ad[(i1 - 2 - 1) + k]);
        }
        doublew.val = Math.min(doublew.val, doublew4.val);
        doublew1.val = doublew.val;
        i1 += 4;
        j1 = (i1 + 2 * l) - 1;
        ad[(i1 - 2 - 1) + k] = doublew4.val + ad[(j1 - 1) + k];
        if(ad[(i1 - 2 - 1) + k] == 0.0D)
        {
            ad[(i1 - 1) + k] = 0.0D;
        ...
        if((d2 * ad[((j1 + 2) - 1) + k] < ad[(i1 - 2 - 1) + k]) && (d2 * ad[(i1 - 2 - 1) + k] < ad[((j1 + 2) - 1) + k]))
        {
            double d7 = ad[((j1 + 2) - 1) + k] / ad[(i1 - 2 - 1) + k];
            ad[(i1 - 1) + k] = ad[(j1 - 1) + k] * d7;
            doublew3.val = doublew4.val * d7;
        } else
        {
            ad[(i1 - 1) + k] = ad[((j1 + 2) - 1) + k] * (ad[(j1 - 1) + k] / ad[(i1 - 2 - 1) + k]);
            doublew3.val = ad[((j1 + 2) - 1) + k] * (doublew4.val / ad[(i1 - 2 - 1) + k]);
        }
