    ...
    public static void dlas2(double d, double d1, double d2, doubleW doublew, doubleW doublew1)
    {
        ...
        if(d16 == 0.0D)
        {
            ...
            if(d17 == 0.0D)
                ...
                doublew1.val = Math.max(d17, d18) * Math.sqrt(1.0D + Math.pow(Math.min(d17, d18) / Math.max(d17, d18), 2));
        } else
        if(d18 < d17)
        {
            double d4 = 1.0D + d16 / d17;
            double d7 = (d17 - d16) / d17;
            double d10 = Math.pow(d18 / d17, 2);
            double d13 = 2D / (Math.sqrt(d4 * d4 + d10) + Math.sqrt(d7 * d7 + d10));
            doublew.val = d16 * d13;
        ...
        } else
        {
            ...
            {
                double d5 = 1.0D + d16 / d17;
                double d8 = (d17 - d16) / d17;
                double d14 = 1.0D / (Math.sqrt(1.0D + Math.pow(d5 * d11, 2)) + Math.sqrt(1.0D + Math.pow(d8 * d11, 2)));
