...
label0:
        {
            ...
            if(i == 1)
            {
                doublew.val = Math.sqrt(ad[(1 - 1) + k] * ad[(1 - 1) + k] + d * ad1[(1 - 1) + l] * ad1[(1 - 1) + l]);
                ad2[(1 - 1) + i1] = 1.0D;
                ad3[(1 - 1) + j1] = 1.0D;
                return;
            }
            ...
            if(j == i)
            {
                ...
                if(d75 <= 0.0D)
                {
                    ...
                    d57 = (ad1[(i - 1 - 1) + l] * ad1[(i - 1 - 1) + l]) / ((ad[(i - 1 - 1) + k] + d63) * ((ad[(i - 1) + k] - ad[(i - 1 - 1) + k]) + d / (ad[(i - 1) + k] + d63))) + (ad1[(i - 1) + l] * ad1[(i - 1) + l]) / d;
                    if(d19 <= d57)
                    {
                        d56 = d;
                    } else
                    {
                        d24 = (ad[(i - 1) + k] - ad[(i - 1 - 1) + k]) * (ad[(i - 1) + k] + ad[(i - 1 - 1) + k]);
                        double d2 = -(d19 * d24) + ad1[(i - 1 - 1) + l] * ad1[(i - 1 - 1) + l] + ad1[(i - 1) + l] * ad1[(i - 1) + l];
                        double d11 = ad1[(i - 1) + l] * ad1[(i - 1) + l] * d24;
                        if(d2 < 0.0D)
                            d56 = (2D * d11) / (Math.sqrt(d2 * d2 + 4D * d11 * d19) - d2);
                        else
                            d56 = (d2 + Math.sqrt(d2 * d2 + 4D * d11 * d19)) / (2D * d19);
                    }
                } else
                {
                    d24 = (ad[(i - 1) + k] - ad[(i - 1 - 1) + k]) * (ad[(i - 1) + k] + ad[(i - 1 - 1) + k]);
                    double d3 = -(d19 * d24) + ad1[(i - 1 - 1) + l] * ad1[(i - 1 - 1) + l] + ad1[(i - 1) + l] * ad1[(i - 1) + l];
                    double d12 = ad1[(i - 1) + l] * ad1[(i - 1) + l] * d24;
                    if(d3 < 0.0D)
                        d56 = (2D * d12) / (Math.sqrt(d3 * d3 + 4D * d12 * d19) - d3);
                    else
                        d56 = (d3 + Math.sqrt(d3 * d3 + 4D * d12 * d19)) / (2D * d19);
                }
                ...
                d49 = ad1[(i - 1) + l] * d57;
                d26 = d57 * d57;
                d48 = ((8D * (-d49 - d52) + d48) - d49) + d53 + Math.abs(d56) * (d27 + d26);
                d75 = d53 + d49 + d52;
                if(Math.abs(d75) <= d47 * d48)
                    break label0;
                j3++;
                double d44 = ad3[(i - 1 - 1) + j1] * ad2[(i - 1 - 1) + i1];
                ...
                if(d4 >= 0.0D)
                    doublew1.val = (d4 + Math.sqrt(Math.abs(d4 * d4 - 4D * d13 * d19))) / (2D * d19);
                else
                    doublew1.val = (2D * d13) / (d4 - Math.sqrt(Math.abs(d4 * d4 - 4D * d13 * d19)));
                if(d75 * doublew1.val > 0.0D)
                ...
                k2 = j3 + 1;
                j3 = k2;
                for(int i5 = (20 - k2) + 1; i5 > 0; i5--)
                {
                    if(Math.abs(d75) <= d47 * d48)
                        break label0;
                    double d45 = ad3[(i - 1 - 1) + j1] * ad2[(i - 1 - 1) + i1];
                    double d42 = ad3[(i - 1) + j1] * ad2[(i - 1) + i1];
                    d19 = d75 - d45 * d27 - d42 * d26;
                    double d5 = (d42 + d45) * d75 - d45 * d42 * (d27 + d26);
                    double d14 = d45 * d42 * d75;
                    if(d5 >= 0.0D)
                        doublew1.val = (d5 + Math.sqrt(Math.abs(d5 * d5 - 4D * d14 * d19))) / (2D * d19);
                    else
                        doublew1.val = (2D * d14) / (d5 - Math.sqrt(Math.abs(d5 * d5 - 4D * d14 * d19)));
                    if(d75 * doublew1.val > 0.0D)
                        doublew1.val = -(d75 / (d27 + d26));
                    d57 = doublew1.val - d42;
                    if(d57 <= 0.0D)
                        doublew1.val = doublew1.val / 2D;
                    d56 += doublew1.val;
                    doublew1.val = doublew1.val / (doublew.val + Math.sqrt(doublew1.val + doublew.val * doublew.val));
                    l2 = 1;
            ...
            if(d75 > 0.0D)
            {
                ...
                if(d6 > 0.0D)
                    d56 = (2D * d15) / (d6 + Math.sqrt(Math.abs(d6 * d6 - 4D * d15 * d19)));
                else
                    d56 = (d6 - Math.sqrt(Math.abs(d6 * d6 - 4D * d15 * d19))) / (2D * d19);
            ...
            } else
            {
                ...
                if(d7 < 0.0D)
                    d56 = (2D * d16) / (d7 - Math.sqrt(Math.abs(d7 * d7 + 4D * d16 * d19)));
                else
                    d56 = -((d7 + Math.sqrt(Math.abs(d7 * d7 + 4D * d16 * d19))) / (2D * d19));
            ...
            d57 = ad1[(k1 - 1) + l] * d57;
            d75 += d57;
            d48 = 8D * (d49 - d52) + d48 + 2D * d53 + 3D * Math.abs(d57) + Math.abs(d56) * d46;
            if(Math.abs(d75) <= d47 * d48)
                break label0;
            if(d75 <= 0.0D)
            ...
            if(flag2 ^ true)
            {
                ...
                double d20;
                if(flag)
                    d20 = (d75 - d35 * d46) + d24 * Math.pow(ad1[(j - 1) + l] / d38, 2);
                else
                    d20 = d75 - d38 * d46 - d24 * Math.pow(ad1[(j2 - 1) + l] / d35, 2);
                ...
                if(d8 <= 0.0D)
                    doublew1.val = (d8 - Math.sqrt(Math.abs(d8 * d8 - 4D * d17 * d20))) / (2D * d20);
                else
                    doublew1.val = (2D * d17) / (d8 + Math.sqrt(Math.abs(d8 * d8 - 4D * d17 * d20)));
            } else
            {
                ...
                if(flag)
                {
                    ...
                    ad5[1 - 1] = ad1[(l1 - 1) + l] * ad1[(l1 - 1) + l];
                    if(d27 < d64)
                        ad5[3 - 1] = d32 * d32 * d26;
                    else
                        ad5[3 - 1] = d32 * d32 * ((d27 - d64) + d26);
                } else
                {
                    ...
                    if(d26 < d65)
                        ...
                        ad5[1 - 1] = d29 * d29 * (d27 + (d26 - d65));
                    ad5[3 - 1] = ad1[(i2 - 1) + l] * ad1[(i2 - 1) + l];
                }
                ad5[2 - 1] = ad1[(k1 - 1) + l] * ad1[(k1 - 1) + l];
                ad4[1 - 1] = d29;
                ad4[2 - 1] = ad2[(k1 - 1) + i1] * ad3[(k1 - 1) + j1];
                ad4[3 - 1] = d32;
            ...
            if((d57 > d55) || (d57 < d54))
                if(d75 < 0.0D)
                    doublew1.val = (d55 - d56) / 2D;
                else
                    doublew1.val = (d54 - d56) / 2D;
            d56 += doublew1.val;
            ...
            for(int l7 = (20 - k2) + 1; l7 > 0; l7--)
            {
                ...
                if(flag2 ^ true)
                {
                    ...
                    {
                        if(flag)
                            d22 = (d75 - d36 * d46) + d24 * Math.pow(ad1[(j - 1) + l] / d39, 2);
                        else
                            d22 = d75 - d39 * d46 - d24 * Math.pow(ad1[(j2 - 1) + l] / d36, 2);
                    } else
                    {
                    ...
                    if(d9 <= 0.0D)
                        doublew1.val = (d9 - Math.sqrt(Math.abs(d9 * d9 - 4D * d18 * d22))) / (2D * d22);
                    else
                        doublew1.val = (2D * d18) / (d9 + Math.sqrt(Math.abs(d9 * d9 - 4D * d18 * d22)));
                } else
                {
                ...
                d60 = ad1[(k1 - 1) + l] * d60;
                d75 = d53 + d49 + d52 + d60;
                d48 = 8D * (d49 - d52) + d48 + 2D * d53 + 3D * Math.abs(d60) + Math.abs(d56) * d46;
                if((d75 * d51 > 0.0D) && (Math.abs(d75) > Math.abs(d51) / 10D))
                    flag1 ^= true;
                if(d75 <= 0.0D)
                    d54 = Math.max(d54, d56);
                else
