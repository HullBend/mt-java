        ...
        if(d == 0.0D)
        {
            if(flag3)
            {
                if(d1 == 0.0D)
                {
                    ...
                    {
                        int i2 = 1;
                        for(int j10 = (i5 - 1) + 1; j10 > 0; j10--)
                        {
                            ad2[(i2 - 1) + (i5 - 1) * l1 + k1] = 0.0D;
                            i2++;
                        }
        ...
        if(Lsame.lsame(s1, "N"))
        {
            if(flag3)
            {
                ...
                for(int j9 = (i - 1) + 1; j9 > 0; j9--)
                {
                    ...
                    {
                        int i3 = 1;
                        for(int j11 = (i6 - 1) + 1; j11 > 0; j11--)
                        {
                            ad2[(i3 - 1) + (i6 - 1) * l1 + k1] = 0.0D;
                            i3++;
                        }
                    ...
                    {
                        if((ad[(i6 - 1) + (i7 - 1) * l + k] != 0.0D) || (ad1[(i6 - 1) + (i7 - 1) * j1 + i1] != 0.0D))
                        {
                            double d3 = d * ad1[(i6 - 1) + (i7 - 1) * j1 + i1];
                            double d8 = d * ad[(i6 - 1) + (i7 - 1) * l + k];
                            int k3 = 1;
                            for(int j13 = (i6 - 1) + 1; j13 > 0; j13--)
                            {
            ...
            } else
            {
                ...
                for(int k9 = (i - 1) + 1; k9 > 0; k9--)
                {
                    ...
                    int j7 = 1;
                    for(int k12 = (j - 1) + 1; k12 > 0; k12--)
                    {
                        if((ad[(j6 - 1) + (j7 - 1) * l + k] != 0.0D) || (ad1[(j6 - 1) + (j7 - 1) * j1 + i1] != 0.0D))
                        {
