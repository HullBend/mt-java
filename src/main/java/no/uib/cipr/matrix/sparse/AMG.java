...
public class AMG implements Preconditioner {
    ...
    private static class Aggregator {
         ...
         */
        private static List<Set<Integer>> enlargeAggregates(List<Set<Integer>> C,
                List<Set<Integer>> N, boolean[] R) {
         ...
         */
        private static List<Set<Integer>> createFinalAggregates(List<Set<Integer>> C,
                List<Set<Integer>> N, boolean[] R) {
    ...
    private static class Interpolator {
         ...
         */
        private static CompRowMatrix createGalerkinFast(CompRowMatrix A, int[] pt,
                int c) {
            int n = pt.length;
